        ...
        <div id="nav-menu" className="navbar">
          <div className="wrapper">
            <div className="wrapperLeft">
              <div>
                <Tooltip hasArrow label="Women" bg="gray.300" color="black">
                  <Link
                    to="/women"
                    smooth={true}
                    offset={-100}
              ...
              <div>
                <Tooltip hasArrow label="Men" bg="gray.300" color="black">
                  <Link
                    to="/men"
                    smooth={true}
                    offset={-79}
              ...
              <div>
                <Tooltip hasArrow label="Clearance" bg="gray.300" color="black">
                  <Link
                    to="/clearance"
                    smooth={true}
                    offset={-79}
              ...
              <div>
                <Tooltip hasArrow label="Jeans" bg="gray.300" color="black">
                  <Link
                    to="/"
                    smooth={true}
                    offset={-79}
          ...
          <div className="post-all">
            <div className="post-two">
              <p>
                ...
                measures in our warehouse to ensure the health and <br /> safety
                of our customers and associates. Because of this your shipment
                may experience delays. Thank you for your patience and
                understanding.
              </p>
            </div>
            <a href="#0" className="pj6-color-inherit">
